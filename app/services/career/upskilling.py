...
def build_skill_gap_analysis(
    *,
    ...
    matched = sorted(required_skills & normalized_user)
    missing = sorted(required_skills - normalized_user)

    gap_score = (len(missing) / len(required_skills)) if required_skills else 0.0
