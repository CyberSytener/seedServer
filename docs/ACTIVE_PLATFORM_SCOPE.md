...
The next active development area is a natural-language proposal and model
provider adapter, verified secret/dependency fulfillment, native-operation
visibility, and public-key publication evidence:
