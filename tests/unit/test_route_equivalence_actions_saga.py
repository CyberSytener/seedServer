...
def test_action_and_saga_routes_are_registered_once_and_via_extracted_router(monkeypatch, tmp_path):
    monkeypatch.setenv("SEED_DB_PATH", str(tmp_path / "route_eq_actions_saga.db"))
    ...
    expected_modules = {
        ("POST", "/api/v1/test/action-echo"): "app.api.actions_saga_routes",
        ("POST", "/api/v1/actions/invoke"): "app.api.actions_saga_routes",
        ("POST", "/api/v1/chat"): "app.api.actions_saga_routes",
        ("POST", "/api/v1/actions/{action_id}/confirm"): "app.api.actions_saga_routes",
        ("POST", "/api/v1/actions/{action_id}/cancel"): "app.api.actions_saga_routes",
        ("GET", "/api/v1/sagas/{saga_id}"): "app.api.actions_saga_routes",
        ("GET", "/api/v1/sagas/{saga_id}/audit"): "app.api.actions_saga_routes",
    }
