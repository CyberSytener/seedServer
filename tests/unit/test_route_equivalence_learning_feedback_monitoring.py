...
def test_learning_feedback_monitoring_routes_registered_once_and_via_extracted_router(monkeypatch, tmp_path):
    monkeypatch.setenv("SEED_DB_PATH", str(tmp_path / "route_eq_learning_feedback_monitoring.db"))
    ...
    expected_modules = {
        ("GET", "/v1/learning/profile"): "app.api.learning_feedback_monitoring_routes",
        ("POST", "/v1/learning/profile/upsert"): "app.api.learning_feedback_monitoring_routes",
        ("PATCH", "/v1/learning/profile"): "app.api.learning_feedback_monitoring_routes",
        ("GET", "/v1/learning/recommendations"): "app.api.learning_feedback_monitoring_routes",
        ("POST", "/v1/learning/plan/generate"): "app.api.learning_feedback_monitoring_routes",
        ("POST", "/v1/feedback/bug-reports"): "app.api.learning_feedback_monitoring_routes",
        ("GET", "/v1/monitoring/performance"): "app.api.learning_feedback_monitoring_routes",
        ("GET", "/v1/monitoring/health"): "app.api.learning_feedback_monitoring_routes",
        ("GET", "/v1/monitoring/slo"): "app.api.learning_feedback_monitoring_routes",
        ("GET", "/v1/monitoring/slo/{slo_name}/history"): "app.api.learning_feedback_monitoring_routes",
    }
