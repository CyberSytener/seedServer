...
def test_auth_admin_routes_are_registered_once_and_via_extracted_routers(monkeypatch, tmp_path):
    monkeypatch.setenv("SEED_DB_PATH", str(tmp_path / "route_eq.db"))
    ...
    expected_modules = {
        ("POST", "/api/v1/auth/login"): "app.api.auth_routes",
        ("POST", "/api/v1/auth/refresh"): "app.api.auth_routes",
        ("POST", "/api/v1/auth/logout"): "app.api.auth_routes",
        ("POST", "/v1/users"): "app.api.auth_routes",
        ("GET", "/v1/me"): "app.api.auth_routes",
        ("GET", "/v1/models"): "app.api.auth_routes",
        ("POST", "/v1/admin/mode"): "app.api.admin_routes",
        ("GET", "/v1/feature-flags"): "app.api.admin_routes",
        ("POST", "/v1/feature-flags/{flag_name}/toggle"): "app.api.admin_routes",
        ("POST", "/v1/admin/keys/{user_id}/rotate"): "app.api.admin_routes",
        ("GET", "/v1/admin/keys/{user_id}/audit"): "app.api.admin_routes",
    }
