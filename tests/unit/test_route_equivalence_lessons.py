...
def test_lessons_routes_are_registered_once_and_via_extracted_router(monkeypatch, tmp_path):
    monkeypatch.setenv("SEED_DB_PATH", str(tmp_path / "route_eq_lessons.db"))
    ...
    expected_modules = {
        ("POST", "/v1/lessons/generate"): "app.api.lessons_routes",
        ("GET", "/v1/lessons/health"): "app.api.lessons_routes",
        ("GET", "/v1/user/learning-path"): "app.api.lessons_routes",
        ("POST", "/v1/user/start-node"): "app.api.lessons_routes",
        ("POST", "/v1/user/complete-node"): "app.api.lessons_routes",
        ("POST", "/v1/lessons/submit"): "app.api.lessons_routes",
        ("GET", "/v1/lessons"): "app.api.lessons_routes",
        ("GET", "/v1/lessons/{lesson_id}"): "app.api.lessons_routes",
        ("DELETE", "/v1/lessons/{lesson_id}"): "app.api.lessons_routes",
    }
