...
def test_career_routes_are_registered_once_and_via_extracted_router(monkeypatch, tmp_path):
    monkeypatch.setenv("SEED_DB_PATH", str(tmp_path / "route_eq_career.db"))
    ...
    expected_modules = {
        ("POST", "/v1/career/upskilling/plan"): "app.api.career_routes",
        ("POST", "/v1/career/analysis"): "app.api.career_routes",
        ("GET", "/v1/career/analysis/{analysis_id}"): "app.api.career_routes",
        ("PATCH", "/v1/career/analysis/{analysis_id}"): "app.api.career_routes",
        ("POST", "/v1/career/analysis/{analysis_id}/track"): "app.api.career_routes",
        ("GET", "/v1/career/tracks"): "app.api.career_routes",
        ("GET", "/v1/career/tracks/{track_id}"): "app.api.career_routes",
        ("PATCH", "/v1/career/tracks/{track_id}/modules/{module_id}"): "app.api.career_routes",
        ("POST", "/v1/career/tracks/{track_id}/lessons"): "app.api.career_routes",
        ("GET", "/v1/career/lessons"): "app.api.career_routes",
        ("PATCH", "/v1/career/lessons/{lesson_id}"): "app.api.career_routes",
    }
