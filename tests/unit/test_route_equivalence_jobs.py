...
def test_jobs_routes_are_registered_once_and_via_extracted_router(monkeypatch, tmp_path):
    monkeypatch.setenv("SEED_DB_PATH", str(tmp_path / "route_eq_jobs.db"))
    ...
    expected_modules = {
        ("GET", "/v1/jobs/{job_id}"): "app.api.jobs_routes",
        ("POST", "/v1/jobs/{job_id}/cancel"): "app.api.jobs_routes",
    }
